    ...
    <group dispose={null}>
        <group ref={refsToUse[0]} name="Schiltgrat" position={[1254.171, 1945.201, 1642.685]}>
          ...
          <group name="Connection_Schiltgrad" position={[-1254.171, -1945.201, -1642.685]}>
            ...
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable009" geometry={nodes.Cable009.geometry} material={materials['Material.016']} position={[1254.171, 1945.201, 1642.685]} />
          </group>
          <group name="Schiltgrad_Bottom" position={[793.847, -379.49, 50.833]} rotation={[-3.097, 0.098, -2.971]} scale={2}>
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="stop-mesh" geometry={nodes['stop-mesh'].geometry} material={materials.silver_dark} />
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="stop-mesh_1" geometry={nodes['stop-mesh_1'].geometry} material={materials['black.002']} />
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="stop-mesh_2" geometry={nodes['stop-mesh_2'].geometry} material={materials['silver.002']} />
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="stop-mesh_3" geometry={nodes['stop-mesh_3'].geometry} material={materials.red} />
          </group>
          ...
          <group name="Tower_Single_Schiltgrad_1" position={[368.197, -203.725, 31.802]} rotation={[0, -0.087, -0.249]} scale={2}>
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="tower-single-mesh" geometry={nodes['tower-single-mesh'].geometry} material={materials['silver.007']} />
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="tower-single-mesh_1" geometry={nodes['tower-single-mesh_1'].geometry} material={materials['black.005']} />
            <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="tower-single-mesh_2" geometry={nodes['tower-single-mesh_2'].geometry} material={materials['dark-silver.002']} />
          </group>
      ...
      <group name="Gimmeln" ref={refsToUse[1]}  position={[1000.522, 1915.129, 2011.707]}>
        ...
        <group name="Connection_Gimmeln" position={[-1000.522, -1915.129, -2011.707]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable002" geometry={nodes.Cable002.geometry} material={materials['Material.008']} position={[1000.522, 1915.129, 2011.707]} />
        </group>
        <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Gimmeln_Bottom" geometry={nodes.Gimmeln_Bottom.geometry} material={materials['silver.003']} position={[331.159, -174.702, 340.568]} rotation={[3.056, 0.764, -2.956]} scale={2}>
          <group name="Cable-Bottom002" position={[0.294, 10.682, -0.068]} rotation={[-3.082, -0.766, -2.966]} scale={0.5} />
        </mesh>
        <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Gimmeln_Top" geometry={nodes.Gimmeln_Top.geometry} material={materials['silver.003']} position={[-337.375, 133.764, -348.63]} rotation={[0.186, -0.782, -0.225]} scale={2}>
      ...
      <group name="Riggli" ref={refsToUse[2]}  position={[-223.132, 2473.788, 604.987]}>
        ...
        <group name="Connection_Riggli" position={[223.132, -2473.788, -604.987]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable006" geometry={nodes.Cable006.geometry} material={materials['Material.013']} position={[-224.912, 2475.518, 607.751]} />
        </group>
      ...
      <group name="Muttleren" ref={refsToUse[3]}  position={[225.145, 2298.642, 322.65]}>
        ...
        <group name="Connection_Muttleren" position={[-225.145, -2298.642, -322.65]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable007" geometry={nodes.Cable007.geometry} material={materials['Material.014']} position={[225.145, 2298.642, 322.65]} />
        </group>
      ...
      <group name="Kandahar" ref={refsToUse[4]} position={[769.546, 2272.899, 260.332]}>
        ...
        <group name="Connection_Kandahar" position={[-769.546, -2272.899, -260.332]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable008" geometry={nodes.Cable008.geometry} material={materials['Material.015']} />
        </group>
      ...
      <group name="Mürren - Allmendhubel" ref={refsToUse[5]} position={[2108.395, 1737.734, 1079.673]}>
        ...
        <group name="Connection_Mürren-Allmendhubel" position={[-2108.395, -1737.734, -1079.673]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable001" geometry={nodes.Cable001.geometry} material={materials['Material.009']} position={[2108.395, 1737.734, 1079.673]} />
        </group>
      ...
      <group name="Allmendhubel" ref={refsToUse[6]} position={[1913.083, 1872.925, 835.692]}>
        ...
        <group name="Connection_Allmendhubel" position={[-1913.083, -1872.925, -835.692]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable015" geometry={nodes.Cable015.geometry} material={materials['Material.023']} position={[1913.083, 1872.925, 835.692]} />
        </group>
        <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Allmendhubel_Bottom" geometry={nodes.Allmendhubel_Bottom.geometry} material={materials['silver.003']} position={[126.093, -44.952, -13.232]} rotation={[Math.PI, -0.078, Math.PI]} scale={2} />
        <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Allmendhubel_Top" geometry={nodes.Allmendhubel_Top.geometry} material={materials['silver.003']} position={[-126.083, 1.898, 13.356]} rotation={[0, 0.078, 0]} scale={2} />
      </group>
      <group name="Almiboden" ref={refsToUse[7]} position={[1854.261, 1832.072, 719.743]}>
        ...
        <group name="Connection_Allmidboden" position={[-1854.261, -1832.072, -719.743]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable004" geometry={nodes.Cable004.geometry} material={materials['Material.011']} position={[1854.261, 1832.124, 719.743]} />
        </group>
      ...
      <group name="Maulerhubel" position={[1884.768, 1869.85, 335.395]} ref={refsToUse[8]}>
        ...
        <group name="Connection_Maulerhubel" position={[-1884.768, -1869.85, -335.395]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable003" geometry={nodes.Cable003.geometry} material={materials['Material.010']} position={[1884.768, 1869.85, 335.395]} />
        </group>
      ...
      <group name="Winteregg" position={[2127.418, 1770.693, -469.038]} ref={refsToUse[9]}>
        ...
        <group name="Connection_Winteregg" position={[-2127.418, -1770.693, 469.038]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable005" geometry={nodes.Cable005.geometry} material={materials['Material.012']} position={[2127.418, 1770.693, -469.038]} />
        </group>
      ...
      <group name="Lauterbrunnen - Grütschalp" position={[2668.008, 1106.142, -2902.455]} ref={refsToUse[10]}>
        ...
        <group name="Connection_Lauterbrunnen-Grütschalp" position={[-2668.008, -1106.142, 2902.455]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable010" geometry={nodes.Cable010.geometry} material={materials['Material.018']} position={[2668.008, 1106.142, -2902.455]} />
        </group>
        <group name="Gondola_Lauterbrunnen-Grütschalp" rotation={[0, 0.214, 0]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh" geometry={nodes['gondola-mesh'].geometry} material={materials['Material.017']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh_1" geometry={nodes['gondola-mesh_1'].geometry} material={materials['silver.008']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh_2" geometry={nodes['gondola-mesh_2'].geometry} material={materials['glass.001']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh_3" geometry={nodes['gondola-mesh_3'].geometry} material={materials['black.006']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh_4" geometry={nodes['gondola-mesh_4'].geometry} material={materials.white} />
        </group>
        <group name="Lauterbrunnen-Grütschalp_Bottom" position={[628.846, -358.022, -144.027]} rotation={[Math.PI, -0.214, Math.PI]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh" geometry={nodes['gondolastation-mesh'].geometry} material={materials.roof} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_1" geometry={nodes['gondolastation-mesh_1'].geometry} material={materials['white.001']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_2" geometry={nodes['gondolastation-mesh_2'].geometry} material={materials.glass} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_3" geometry={nodes['gondolastation-mesh_3'].geometry} material={materials.sliver} />
        </group>
      ...
      <group name="Gimmelwald - Mürren" position={[2179.761, 1467.188, 2160.75]} ref={refsToUse[11]}>
        ...
        <group name="Connection_Gimmelwald-Mürren" position={[-2179.761, -1467.188, -2160.75]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable012" geometry={nodes.Cable012.geometry} material={materials['Material.020']} position={[2179.761, 1467.188, 2160.75]} />
        </group>
        ...
        <group name="Gimmelwald-Mürren_Bottom" position={[76.119, -144.599, 590.485]} rotation={[-Math.PI, 1.412, -Math.PI]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_4" geometry={nodes['gondolastation-mesh_4'].geometry} material={materials.roof} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_5" geometry={nodes['gondolastation-mesh_5'].geometry} material={materials['white.001']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_6" geometry={nodes['gondolastation-mesh_6'].geometry} material={materials.glass} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_7" geometry={nodes['gondolastation-mesh_7'].geometry} material={materials.sliver} />
        </group>
        <group name="Gondola_Gimmelwald-Mürren" rotation={[0, -1.412, 0]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh-flat" geometry={nodes['gondola-mesh-flat'].geometry} material={materials['Material.025']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh-flat_1" geometry={nodes['gondola-mesh-flat_1'].geometry} material={materials['silver.012']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh-flat_2" geometry={nodes['gondola-mesh-flat_2'].geometry} material={materials['glass.003']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh-flat_3" geometry={nodes['gondola-mesh-flat_3'].geometry} material={materials['black.008']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondola-mesh-flat_4" geometry={nodes['gondola-mesh-flat_4'].geometry} material={materials['white.003']} />
        </group>
      </group>
      <group name="Mürren - Birg" position={[812.659, 2119.946, 1316.6]} ref={refsToUse[12]}>
        ...
        <group name="Connection_Mürren-Birg" position={[-812.659, -2119.946, -1316.6]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable013" geometry={nodes.Cable013.geometry} material={materials['Material.021']} position={[812.659, 2119.946, 1316.6]} />
        </group>
      ...
      <group name="Birg - Schilthorn" position={[-1392.33, 2783.364, 1380.52]} ref={refsToUse[13]}>
        ...
        <group name="Connection_Birg-Schilthorn" position={[1392.33, -2783.364, -1380.52]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable014" geometry={nodes.Cable014.geometry} material={materials['Material.022']} position={[-1392.33, 2783.364, 1380.52]} />
        </group>
      ...
      <group name="Stechelberg - Gimmelwald" position={[2599.527, 1083.709, 2283.661]} ref={refsToUse[14]}>
        ...
        <group name="Connection_Stechelberg-Gimmelwald" position={[-2599.527, -1083.709, -2283.661]}>
          ...
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="Cable011" geometry={nodes.Cable011.geometry} material={materials['Material.019']} position={[2599.527, 1083.709, 2283.661]} />
        </group>
        ...
        <group name="Stechelberg-Gimmelwald_Bottom" position={[307.619, -271.554, -437.713]} rotation={[Math.PI, -0.967, Math.PI]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_8" geometry={nodes['gondolastation-mesh_8'].geometry} material={materials.roof} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_9" geometry={nodes['gondolastation-mesh_9'].geometry} material={materials['white.001']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_10" geometry={nodes['gondolastation-mesh_10'].geometry} material={materials.glass} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_11" geometry={nodes['gondolastation-mesh_11'].geometry} material={materials.sliver} />
        </group>
        <group name="Stechelberg-Gimmelwald_Top" position={[-304.691, 226.419, 439.544]} rotation={[0, 0.967, 0]}>
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_12" geometry={nodes['gondolastation-mesh_12'].geometry} material={materials.roof} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_13" geometry={nodes['gondolastation-mesh_13'].geometry} material={materials['white.001']} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_14" geometry={nodes['gondolastation-mesh_14'].geometry} material={materials.glass} />
          <mesh castShadow={liftShadow} receiveShadow={liftShadow} name="gondolastation-mesh_15" geometry={nodes['gondolastation-mesh_15'].geometry} material={materials.sliver} />
        </group>
      </group>
    </group>
  )
