  ...
  return (
    <group {...props} dispose={null}>
      <group name="Schilthornhütte" position={[-102.681, 2387.01, 224.249]} rotation={[Math.PI, -0.838, Math.PI]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Schilthornhütte" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Schilthornhütte", days: "Mo - So", website: "https://www.schilthornhuette.com/", contact: "+41 33 855 50 53" }} />
        </Html>
      ...
      <group name="Bistro_Birg" position={[-503.996, 2628.053, 1101.381]} rotation={[-Math.PI, 0.737, -Math.PI]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Bistro Birg" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Bistro Birg", days: "Mo - So", hours: "08:00 - 16:00", website: "https://schilthorn.ch/21/de/Bistro_Birg", contact: "+41 33 826 00 07" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Bergrestaurant_Gimmeln" position={[1297.245, 1756.945, 2401.545]} rotation={[0, -0.36, 0]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Restaurant Gimmelen" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Restaurant Gimmelen", contact: "+41 33 856 21 41" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Hotel_Restaurant_Sonnenberg" position={[1352.938, 1792.656, 960.82]} rotation={[0, -0.458, 0]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Hotel Sonnenberg" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Hotel Sonnenberg", days: "Mo - So", contact: "+41 33 855 11 27", website: "https://www.restaurant-sonnenberg.ch/" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Pension_Suppenalp" position={[1200.87, 1802.154, 1228.006]} rotation={[0, -1.421, 0]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Pension Suppenalp" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Pension Suppenalp", days: "Mo - So", website: "https://www.suppenalp.ch/", contact: "+41 33 855 17 26" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Restaurant_Allmendhubel" position={[1881.04, 1879.211, 890.186]} rotation={[Math.PI, -0.179, Math.PI]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Allmendhubel" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Allmendhubel", days: "Mo - So", hours: "09:00 - 17:00", website: "https://schilthorn.ch/25/de/Panorama_Restaurant_Allmendhubel", contact: "+41 33 855 25 12" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Schiltgrathüsi" position={[614.898, 2076.181, 1612.265]} rotation={[-Math.PI, 0.088, -Math.PI]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Schiltgrathüsi" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Schiltgrathüsi", days: "Mo - So", website: "https://jungfrauregion.swiss/de/sommer/essen-und-uebernachten/gastronomie/schiltgrathuesi-bergrestaurant/", contact: "+41 79 742 44 55" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Winteregg" position={[2492.704, 1533.412, -1103.69]} scale={3}>
        <Html  zIndexRange={[activeRestaurant == "Winteregg" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "Winteregg", days: "Mo - So", website: "https://jungfrauregion.swiss/de/sommer/essen-und-uebernachten/gastronomie/winteregg-bergrestaurant/", contact: "+41 33 828 70 90" }} />
        </Html>
        <mesh name="restaurant-mesh" geometry={nodes['restaurant-mesh'].geometry} material={materials['Dark_wood.010']} />
        <mesh name="restaurant-mesh_1" geometry={nodes['restaurant-mesh_1'].geometry} material={materials['Light_wood.010']} />
        <mesh name="restaurant-mesh_2" geometry={nodes['restaurant-mesh_2'].geometry} material={materials['Glass.011']} />
      ...
      <group name="Restaurant_Piz-Gloria" position={[-2219.763, 2915.514, 1627.045]} rotation={[-Math.PI, 0.083, -Math.PI]} scale={1.152}>
        <Html  zIndexRange={[activeRestaurant == "360° Piz Gloria" ? 100000000 : 16777271, 0]} >
          <ToolTipRestaurant handle={handleOpen} restaurant={{ name: "360° Piz Gloria", days: "Mo - So", website: "https://jungfrauregion.swiss/de/winter/essen-und-uebernachten/gastronomie/drehrestaurant-schilthorn-piz-gloria/", contact: "+41 33 826 00 07" }} />
        </Html>
