...
export default function Slopes(
  { allowShadow, refsToUse, setFocusObject },
  props
) {
        ...
        <group position={[0, 0 + moveUp, 0]} {...props} dispose={null}>
          {slope.includes("Schwarz") ? (
            <group name="black-slopes">
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 9 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={9}
                    ...
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 9)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 10 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={10}
                    BageColor={ColorBlackSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 10)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 12 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={12}
                    BageColor={ColorBlackSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 12)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 14 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={14}
                    BageColor={ColorBlackSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 14)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 16 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={16}
                    BageColor={ColorBlackSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 16)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 17 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={17}
                    BageColor={ColorBlackSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 17)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                ...
                {/* tracks[
                        tracks.findIndex((track) => track.mappedNumber == 21)
                      ].status
                } 
                <Html
                  zIndexRange={[activeSlope == 21 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={21}
                    BageColor={ColorBlackSlope}
              ...
              >
                <Html
                  zIndexRange={[activeSlope == "i" ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={"i"}
                    BageColor="#686868"
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.name == "Inferno")
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                ...
                >
                  <BadgeSlopes
                    ...
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 27)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                ...
                >
                  <BadgeSlopes
                    ...
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.name == "23b Finel")
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
          ...
          {slope.includes("Rot") ? (
            <group name="red-slopes">
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 1 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={1}
                    ...
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 1)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 3 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={3}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 3)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 5 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={5}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 5)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 13 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={13}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 13)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 15 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={15}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 15)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 22 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={22}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 22)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 24 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={24}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 24)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 25 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={25}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 25)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 26 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={26}
                    BageColor={ColorRedSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 26)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
          ...
          {slope.includes("Blau") ? (
            <group name="blue-slopes">
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 2 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={2}
                    ...
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 2)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 4 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={4}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 4)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 6 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={6}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 6)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 7 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={7}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 7)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 8 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={8}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 8)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 20 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={20}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 20)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 23 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={23}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 23)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
              ...
              >
                <Html
                  zIndexRange={[activeSlope == 11 ? 100000000 : 16777271, 0]}
                >
                  <BadgeSlopes
                    BadgeNumber={11}
                    BageColor={ColorBlueSlope}
                    Length={
                      tracks[
                        tracks.findIndex((track) => track.mappedNumber == 11)
                      ].lengthInMeter
                    }
                    Status={
                      tracks[
